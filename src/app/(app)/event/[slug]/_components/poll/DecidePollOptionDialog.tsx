...
import { votersLabel } from "./pollUtils";
        ...
        {hasOptions ? (
          <div className="space-y-2">
            {poll.options.map((o) => {
              ...
              const recommended = o.id === recommendedOptionId;
                ...
                >
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="font-medium">{renderOptionLabel(o.label)}</span>
                    ...
                    {!!o.voters?.length && (
                      <p className="text-muted-foreground mt-1 text-xs">{votersLabel(o.voters, meId, 4)}</p>
                    )}
                  </div>

                  {active && <Check className="h-4 w-4 shrink-0 text-[var(--primary)]" />}
                </button>
              );
            })}
          </div>
              ...
              {isLocation ? (
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setManualValue(v);
                    if (v.trim().length > 0) setSelectedOptionId(null);
                  }}
