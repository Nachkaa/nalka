// src/app/(app)/event/[slug]/_components/EventDescriptionSection.tsx
...
export function EventDescriptionSection({
  ...
  // Si pas de description ET que l'utilisateur ne peut pas éditer → masquer complètement
  if (!description && !canEdit) return null;

  const handleSave = () => {
    startTransition(async () => {
      const result = await updateEventDescription(eventId, slug, value);
