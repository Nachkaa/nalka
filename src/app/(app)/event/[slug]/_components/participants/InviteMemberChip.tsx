    ...
    <div className="flex w-16 flex-col items-center">
      <InviteMemberDialog eventId={eventId} asChild>
        <button
          ...
          className="relative inline-flex h-12 w-12 items-center justify-center rounded-full bg-[var(--primary)] text-[var(--primary-foreground)] ring-2 ring-[color-mix(in_oklch,var(--primary),black_20%)] ring-offset-2 transition-transform select-none hover:scale-[1.03] focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-[var(--background)] focus:outline-none"
        >
