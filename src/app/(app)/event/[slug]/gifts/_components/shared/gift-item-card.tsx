...
type GiftItem = {
  ...
  // “réservation visible” (peut être forcé à false si pas de spoil côté bénéficiaire)
  isReserved: boolean;
  isReservedByMe: boolean;

  // nom du réservataire (si autorisé), sinon null
  reservedByName: string | null;

  reservedByNames?: string[];
  isSuggestion?: boolean;

  // NEW: pour gérer “pas de spoil” proprement
      ...
      <CardContent className="flex h-full flex-col p-0">
        ...
        <div
          className={cn(
            ...
            hasImage ? "from-primary/8 to-primary/3" : "from-primary/15 to-primary/5",
          )}
        >
          {hasImage ? (
            <Image
        ...
        <div className="flex flex-1 flex-col p-3">
          <div className="min-h-0">
            ...
            {/* Réservé par X (en bas) uniquement si visible et pas en “no spoil” */}
            {showReservation &&
            !isAnonReservations &&
            !item.isReservedByMe &&
            item.reservedByName ? (
          ...
          {/* Actions en bas (uniquement sur liste des autres) */}
          {!isMyList ? (
