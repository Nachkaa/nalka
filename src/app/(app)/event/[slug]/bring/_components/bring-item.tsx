// app/(app)/event/[slug]/bring/_components/bring-item.tsx
...
export function BringItem({
  ...
  const currentUserBrings = item.bringers.some((b) => b.userId === currentUserId);
  ...
  const bringersLabel = item.bringers
    .map((b) => formatBringerName(b.user, b.userId === currentUserId))
    .join(", ");
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            {item.note && <div className="text-muted-foreground mt-1 text-sm">{item.note}</div>}
          </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Cette action est irréversible. L&apos;élément &quot;{item.label}&quot; sera supprimé
                    définitivement.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
