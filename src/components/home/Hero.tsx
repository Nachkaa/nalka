            ...
            <div className="text-white lg:col-span-7">
              ...
              >
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="rounded-full border-white/50 bg-white/10 px-8 py-6 text-white backdrop-blur-xl transition-all duration-300 hover:bg-white/20 hover:border-white/60"
                >
              ...
              >
                {badges.map((t) => (
                  <span
                    key={t}
                    className="rounded-full bg-white/18 px-3 py-1.5 text-sm text-white/95 backdrop-blur-md shadow-sm"
                  >
                    {t}
                  </span>
                ))}
