...
const steps = [
  ...
  },
  {
    ...
    icon: (
      <path
        d="M12 12a4 4 0 1 0-4-4m8 8c0-2.2-3-3.5-4-3.5s-4 1.3-4 3.5"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
    ),
  ...
  },
  {
    ...
    icon: (
      <>
        <path
          d="M12 3l1.2 2.6 2.8.2-2.1 1.8.7 2.7L12 8.8 9.4 10.3l.7-2.7L8 5.8l2.8-.2L12 3z"
          strokeWidth="1.6"
        />
  ...
  return (
    <ol className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {steps.map((s) => (
        <li
          key={s.title}
          className="shadow-soft flex flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-black/10 transition-all hover:-translate-y-0.5"
        >
          <div className="min-h-[7.5rem] p-4">
          ...
          <figure className="mt-auto">
            <div className="relative -mx-4 -mb-4 aspect-[4/3]">
              <Image
                src={s.img.src}
                alt={s.img.alt}
                fill
