          ...
          <AlertDialog open={editConfirmOpen} onOpenChange={setEditConfirmOpen}>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Ce cadeau est actuellement réservé. Si tu le modifies, la personne qui l&apos;a
                  réservé sera prévenue par email.
                </AlertDialogDescription>
              </AlertDialogHeader>
        ...
        <AlertDialogContent>
              ...
              <div className="space-y-2">
                ...
                {hasActive && !isNoSpoil && (
                  <>
                    <p>Tu veux retirer {title} de ta liste ?</p>
                    <p>
                      La personne qui l&apos;avait réservé sera prévenue et pourra choisir autre
                      chose.
                    </p>
                  </>
                )}
          ...
          <AlertDialogFooter className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            ...
            >
              ...
              >
                {isDeleting ? "Suppression…" : hasActive ? "Retirer de ma liste" : "Supprimer"}
              </AlertDialogAction>
            </form>
          </AlertDialogFooter>
        </AlertDialogContent>
