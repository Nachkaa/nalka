/*
  ...
  - You are about to drop the column `isGroupGiftAllowed` on the `Event` table. All the data in the column will be lost.
...
INSERT INTO "new_Event" ("budgetCapCents", "budgetCents", "budgetMode", "colorHex", "createdAt", "description", "eventOn", "id", "isAnonReservations", "isHandmadeOk", "isNoSpoil", "isOneGiftPerPerson", "isSecondHandOk", "isWishlinkRequired", "joinCode", "linkEnabled", "location", "ownerId", "settings", "slug", "title", "updatedAt") SELECT "budgetCapCents", "budgetCents", "budgetMode", "colorHex", "createdAt", "description", "eventOn", "id", "isAnonReservations", "isHandmadeOk", "isNoSpoil", "isOneGiftPerPerson", "isSecondHandOk", "isWishlinkRequired", "joinCode", "linkEnabled", "location", "ownerId", "settings", "slug", "title", "updatedAt" FROM "Event";
DROP TABLE "Event";
